    ...
    render() {
        return (
            <div className="create-event-container">
                ...
                <button className="add-event-btn" type="submit" onClick={() => this.submitEvent(this.state.title, this.state.location, this.state.date, this.state.start, this.state.end)}>
                    Submit Event!
                        </button>
            </div>
        )
